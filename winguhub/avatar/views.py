...
from winguhub.avatar.forms import PrimaryAvatarForm, DeleteAvatarForm, UploadAvatarForm,\
    GroupAvatarForm
from winguhub.avatar.models import Avatar, GroupAvatar
from winguhub.avatar.settings import AVATAR_MAX_AVATARS_PER_USER, AVATAR_DEFAULT_SIZE
from winguhub.avatar.signals import avatar_updated
from winguhub.avatar.util import get_primary_avatar, get_default_avatar_url, \
    invalidate_cache, invalidate_group_cache
from winguhub.utils import render_error, render_permission_error, \
