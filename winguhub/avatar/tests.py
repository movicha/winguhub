...
from winguhub.avatar.settings import AVATAR_DEFAULT_URL, AVATAR_MAX_AVATARS_PER_USER
from winguhub.avatar.util import get_primary_avatar
from winguhub.avatar.models import Avatar
