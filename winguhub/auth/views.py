...
from winguhub.auth import REDIRECT_FIELD_NAME
from winguhub.auth import login as auth_login
from winguhub.auth.decorators import login_required
from winguhub.auth.forms import AuthenticationForm
from winguhub.auth.forms import PasswordResetForm, SetPasswordForm, PasswordChangeForm
from winguhub.auth.tokens import default_token_generator
...
def logout(request, next_page=None, template_name='registration/logged_out.html', redirect_field_name=REDIRECT_FIELD_NAME):
    ...
    from winguhub.auth import logout
    logout(request)
